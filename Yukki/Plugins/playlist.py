...
@Client.on_message(command(["playlist", "playlist@QueenAlishaRobot"]) & other_filters)
...
@Client.on_message(command(["delmyplaylist", "delmyplaylist@QueenAlishaRobot"]) & other_filters)
...
@Client.on_message(command(["delchatplaylist", "delchatplaylist@QueenAlisharobot"]) & other_filters)
